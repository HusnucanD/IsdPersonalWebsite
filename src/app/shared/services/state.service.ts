...
export class State {
    ...
    setTabs() {  
        ...
        for(let i = 0; i < object.length; i++) {
            this.tabs.push(
                new Tab(object[i].title, object[i].content, object[i].logoUrl, object[i].imgUrl, object[i].visible));
        }
    }
    ...
    setFaqs() {  
        ...
        for(let i = 0; i < object.length; i++) {
            this.faqs.push(
                new Faq(object[i].id, object[i].title, object[i].answer));
        }
    }
    ...
    setPosts() {        
        ...
        for(let i = 0; i < object.length; i++) {
            this.posts.push(
                new Post(object[i].id, object[i].title, object[i].content, object[i].imgUrl, object[i].author));
        }
    }
}